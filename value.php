<?php
// Script Created By Nirob Shuvo // to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from token folder
